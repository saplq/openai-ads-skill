...
4. Apply mutations only from a redacted, single-use plan with a 15-minute confirmation and persisted idempotency key; treat post-write readback as best-effort verification.
